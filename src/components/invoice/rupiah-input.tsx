  ...
  return (
    <span className="relative block">
      ...
      <input
        ...
        className={clsx(
          "w-full min-h-[44px] rounded-xl border-0 bg-surface px-3 py-2 text-right text-sm tabular-nums text-ink shadow-neu-in placeholder:text-ink-faint focus:outline-none",
          className
        )}
      />
    </span>
